...
namespace API.Controllers
{
    ...
    public class RevenueController(IRevenueServices revenueServices) : ControllerBase
    {
        ...
        {
            var revenues = await _revenueServices.GetAllByUserIdAsync(User);
            return Ok(revenues);
        }
        ...
        {
            var revenue = await _revenueServices.GetByIdAsync(User, id);
            return Ok(revenue);
        }
        ...
        {
            var revenue = await _revenueServices.CreateAsync(User, inputModel);
        ...
        {
            var revenue = await _revenueServices.UpdateAsync(User, id, inputModel);
            return Ok(revenue);
        }
        ...
        {
            await _revenueServices.DeleteAsync(User, id);
            return NoContent();
        }
